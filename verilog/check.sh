...
#yosys-smtbmc -s $1 -t 30 --unroll --dump-smt2 named_unrolled.smt2 --smtc data_integrity.smtc --dump-vcd disb.vcd disb.smt2
# For counter examples -- will file issue or make pull request for Yosys fix soon
yosys-smtbmc -s z3 -t 30 --smtc data_integrity.smtc --dump-vcd disb.vcd disb.smt2
